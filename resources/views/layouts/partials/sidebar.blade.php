<aside class="sidebar desktop-fixed d-none d-lg-flex flex-column">
    ...
    <div class="px-2 pb-3">
        <nav class="nav flex-column">
            ...
            <div class="collapse" id="navMaster">
                <a href="/master/items" class="nav-link mx-1 mb-1"><i class="bi bi-box me-2"></i> Master Item</a>
                <a href="/master/employees" class="nav-link mx-1 mb-1"><i class="bi bi-people me-2"></i> Master
                    Karyawan</a>
            </div>
