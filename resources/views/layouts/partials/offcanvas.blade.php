<div class="offcanvas offcanvas-start sidebar d-lg-none" tabindex="-1" id="offSidebar" aria-labelledby="offSidebarLabel">
    ...
    <div class="offcanvas-body px-2">
        <nav class="nav flex-column">
            ...
            <div class="collapse" id="mMaster">
                <a href="/master/employees" class="nav-link mx-1 mb-1"><i class="bi bi-box me-2"></i> Master Item</a>
                <a href="/master/items" class="nav-link mx-1 mb-1"><i class="bi bi-people me-2"></i> Master Karyawan</a>
            </div>
            ...
            <div class="collapse" id="mPesanan">
                <a href="/shipments" class="nav-link mx-1 mb-1"><i class="bi bi-truck me-2"></i> Pengiriman</a>
                <a href="#" class="nav-link mx-1 mb-1"><i class="bi bi-check2-circle me-2"></i> Pesanan
                    Selesai</a>
            </div>

            <div class="nav-group-title mt-2">Pembelian</div>
            <a class="nav-link mx-1 mb-1" data-bs-toggle="collapse" href="#mPembelian" role="button"
                aria-expanded="false" aria-controls="mPembelian">
                <i class="bi bi-bag-check me-2"></i> Pembelian
                <i class="bi bi-chevron-down small ms-auto"></i>
            </a>
            <div class="collapse" id="mPembelian">
                <a href="#" class="nav-link mx-1 mb-1"><i class="bi bi-hexagon-half me-2"></i> Bahan Baku</a>
                <a href="#" class="nav-link mx-1 mb-1"><i class="bi bi-puzzle me-2"></i> Bahan Pendukung</a>
            </div>
            ...
            <div class="collapse" id="mProduksi">
                <a href="#" class="nav-link mx-1 mb-1"><i class="bi bi-scissors me-2"></i> Cutting</a>
                <a href="#" class="nav-link mx-1 mb-1"><i class="bi bi-threads me-2"></i> Jahit</a>
            </div>

            <div class="nav-group-title mt-2">Lainnya</div>
            <a href="#" class="nav-link mx-1 mb-1"><i class="bi bi-boxes me-2"></i> Gudang</a>
            <a href="#" class="nav-link mx-1 mb-1"><i class="bi bi-bar-chart-line me-2"></i> Laporan</a>
        </nav>
    </div>
</div>
